...
from keras.layers import Input, Dropout, Flatten, Convolution2D, MaxPooling2D, BatchNormalization, Dense, Activation
...
def create_model():
	...
	#opt = RMSprop(lr)
	opt = SGD(lr = 0.0001,momentum=0.1,nesterov = True)
	...
	model.add(Dense(2, init=weight_init, activation='linear'))
